Codeunit 50010 "Seminar Management"
{
    ...
    begin
        ...
        if PSeminarRegHeader.Status <> PSeminarRegHeader.Status::Finished then begin
            exit;
        end;
        ...
        if SeminarRegLine.FindSet() then begin
            ...
            repeat
                ...
                SalesLine.Description := StrSubstNo(DescriptionTemplateTxt, SeminarRegLine."Seminar Registration No.", SeminarRegLine."Participant Name"); //TODO: wprowadź dwa pola wymagane w opisie wiersza faktury );
                SalesLine.Insert();
